...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-50 text-dark">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1 space-y-3">
            <Link to="/" className="inline-block">
              <img src={logo} alt="Live Grid" className="h-10 lg:h-11 w-auto object-contain" />
            </Link>
            <p className="text-dark text-sm font-rubik font-bold uppercase tracking-wide">
              LIVE GRID
            </p>
            <p className="text-gray-medium text-sm font-rubik">
              LiveGrid 2015–2026
            </p>
            <p className="text-gray-medium text-sm font-rubik">
          ...
          <div className="space-y-3">
            <h3 className="flex items-center gap-2 text-dark text-sm font-rubik font-semibold uppercase tracking-wide">
              <GridIcon /> Навигация
            </h3>
          ...
          <div className="space-y-3">
            ...
            <div className="text-gray-medium text-sm font-rubik space-y-1.5">
            ...
            <div className="flex items-center gap-2 pt-2">
              {SOCIAL.map(({ href, Icon, label }) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-white border border-gray-light text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-colors"
                  aria-label={label}
                >
                  <Icon />
                </a>
